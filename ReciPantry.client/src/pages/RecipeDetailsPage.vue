    ...
    <div v-if="recipe" class="theRecipe position-relative">
        ...
        <div class="ingredients-container col-12 col-md-4 p-0 m-0 px-4 mt-4" v-if="recipe.ingredients">
            ...
            <ul class="p-0 m-0 list-unstyled">
                ...
                <li class="bg-white p-0 m-0 mt-3 py-3 px-3 rounded rounded-5 elevation-3 d-flex flex-row justify-content-start align-items-center ingredient" v-for="ingredient in ingredients" :key="ingredient">
