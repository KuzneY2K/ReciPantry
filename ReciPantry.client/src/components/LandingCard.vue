<template>
    <div class="card-container p-0 m-0 text-center rounded rounded-5 elevation-5 position-relative animate__animated animate__bounceInUp" v-if="randomRecipe[0]" :style="{ backgroundImage: 'url(' + randomRecipe[0].image + ')' }">
