<template>
    ...
    <div class="card-container p-0 m-0 text-center border border-2 border-black elevation-5 position-relative animate__animated animate__fadeIn mt-2" v-if="randomRecipe[0]" :style="{ backgroundImage: 'url(' + randomRecipe[0].image + ')' }">    
