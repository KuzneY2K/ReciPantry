<template>
    ...
    <div class="card-container p-0 m-0 rounded rounded-5 my-2 border border-2 border-dark elevation-5 animate__animated animate__fadeInRightBig postion-relative" :style="{ backgroundImage: 'url(' + props.recipe.image + ')' }">
