<template>
  <section class="row p-0 m-0 bg-white position-relative mb-3 mt-3 rounded rounded-3 border border-2 border-black elevation-5">
  ...
  <div class="card-container p-0 m-0 d-flex flex-column align-items-center justify-content-center">
    <div class="card-info p-0 m-0 mt-3">
      <img class="profile-picture p-0 m0" :src="review.profile.picture" alt="">
      ...
      <div v-if="review.rating == 4" class="p-0 m-0"><i class="mdi text-warning mdi-star"></i><i class="mdi text-warning mdi-star"></i><i
          class="mdi text-warning mdi-star"></i><i class="mdi text-warning mdi-star"></i></div>
      <div v-if="review.rating == 3" class="p-0 m-0"><i class="mdi text-warning mdi-star"></i><i class="mdi text-warning mdi-star"></i><i
          class="mdi text-warning mdi-star"></i>
      </div>
      <div v-if="review.rating == 2" class="p-0 m-0"><i class="mdi text-warning mdi-star"></i><i class="mdi text-warning mdi-star"></i>
      </div>
  ...
  <div class="col-8 p-0 m-0 d-flex flex-column justify-content-start align-items-start mt-3">
    ...
    <button v-if="account.id == review.profile.id" class="btn btn-sm btn-danger delete-btn px-2 m-0 rounded rounded-pill position-absolute" @click="deleteReview"><i class="mdi mdi-delete-forever"></i>
    </button>
    </div> 
  </section>
</template>
